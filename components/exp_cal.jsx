...
const TimeDifference = () => {
  ...
  useEffect(() => {
    const calculateTimeDifference = () => {
      ...
      let days = Math.floor(
        (timeDiff % (1000 * 60 * 60 * 24 * 365)) / (1000 * 60 * 60 * 24)
      );
  ...
  return (
    <div className=" group absolute bottom-0 p-4 text-primaryColor ">
      <div className="flex h-full items-end gap-1">
        <h1 className=" md:text-9xl text-7xl font-extrabold flex items-end">
          {yearDifference}
        </h1>
        <div className="mb-2">
          <h1 className="md:text-4xl text-2xl "> Years Of</h1>
