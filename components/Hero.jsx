      ...
      <section className="text-gray-400 bg-gray-900 body-font" id="hero">
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center h-screen xl:w-2/4 lg:w-3/4 w-screen">
          <div className="lg:flex-grow md:w-1/2 lg:pr-2 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            <h4 className="text-2xl md:1xl text-primaryColor">
              Hi There ! I&apos;m{" "}
            </h4>
            <h1 className="title-font md:text-5xl text-3xl mb-4 font-medium text-white">
              Abrar Ul Haque
            </h1>
          ...
          <div className="rounded-full overflow-hidden h-80 w-80 ">
            <Image
              layout="fill"
              objectFit="cover"
              className="object-center rounded-full !relative"
              loading="lazy"
              alt="hero"
              src="/img/personal/Profile.jpeg"
            />
          </div>
        </div>
        <TimeDifference />
